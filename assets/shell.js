...
(function () {
  var V = '20260812h'; // cache-bust for Default thank-you comparison prices
  ...
  function dispatch() {
    ...
    if (p.first === 'checkout') activeId = 'online-store'; // dedicated Checkout editor route lives in the Online store module
